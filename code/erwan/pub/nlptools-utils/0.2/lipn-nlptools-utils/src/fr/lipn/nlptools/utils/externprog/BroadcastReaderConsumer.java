 ...
 */
/*
 * Note for developpers: maybe this class could be more efficient using a read/write lock instead of standard synchronization mechanism:
 * currently all access to the buffer is synchronized, even in the case of readers (only one reader can access the buffer at a time).
