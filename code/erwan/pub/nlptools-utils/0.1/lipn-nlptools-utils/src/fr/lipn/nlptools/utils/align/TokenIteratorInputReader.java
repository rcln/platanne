...
public class TokenIteratorInputReader implements InputReader {
	 ...
	 * @param doNotCompare Skip the comparison between the original (input) token and the one read by the annotated reader. This option should be
	 ...
	 */
	public TokenIteratorInputReader(boolean ignoreCase, Iterator<PositionedText> tokenIterator, Iterator<PositionedText> separatorIterator, boolean doNotCompare, char[] wildcardChars) {
