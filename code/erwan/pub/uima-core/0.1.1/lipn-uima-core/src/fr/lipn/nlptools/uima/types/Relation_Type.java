 ...
 * @generated */
public class Relation_Type extends GenericAnnotation_Type {
  /** @generated */
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("fr.lipn.nlptools.uima.types.Relation");
  ...
  public int getArguments(int addr) {
      ...
      jcas.throwFeatMissing("arguments", "fr.lipn.nlptools.uima.types.Relation");
