...
import fr.lipn.nlptools.uima.lia.ne.LiaNeAnnotatedReader.LiaNeAnnotReceiver;
...
/**
 * TODO doc !!! expliquer pourquoi vue différente et le principe, notamment pourquoi un token par ligne
 * TODO à voir : refaire les Token ?? ou expliquer
 * 
 * @author erwan
 *
 */
