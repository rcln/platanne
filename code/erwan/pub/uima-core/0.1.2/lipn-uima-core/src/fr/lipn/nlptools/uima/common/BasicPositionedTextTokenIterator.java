...
/**
 * This class implements {@link GenericTokenIterator} over {@link PositionedText} elements.
 * 
 * 
 * @author erwan
 *
...
public class BasicPositionedTextTokenIterator extends GenericTokenIterator<PositionedText> {
	 ...
	 */
	public BasicPositionedTextTokenIterator(JCas aJCas, Annotation range, boolean iterateSentences, int tokenType, int sentenceType, String[] regexps, String[] replaceWith, boolean threadSafe, FSMatchConstraint sentenceConstraint, FSMatchConstraint tokenConstraint) {
	...
	public BasicPositionedTextTokenIterator(JCas aJCas, Annotation range, boolean iterateSentences, String[] regexps, String[] replaceWith, boolean threadSafe, FSMatchConstraint sentenceConstraint, FSMatchConstraint tokenConstraint) {
		this(aJCas, range, iterateSentences, DEFAULT_TOKEN_TYPE, DEFAULT_SENTENCE_TYPE, regexps, replaceWith, threadSafe, sentenceConstraint, tokenConstraint);
	}
	...
	public BasicPositionedTextTokenIterator(JCas aJCas, String[] regexps, String[] replaceWith, boolean threadSafe, FSMatchConstraint sentenceConstraint, FSMatchConstraint tokenConstraint) {
		this(aJCas, null, false, DEFAULT_TOKEN_TYPE, DEFAULT_SENTENCE_TYPE, regexps, replaceWith, threadSafe, sentenceConstraint, tokenConstraint);
	}
