...
/*
	...
	*/
	...
	/**
	 * Given an already parsed filter (see {@link #parseAnnotationFilter(JCas, int, String[], boolean, String)}), creates the constraint
	 * 
	 * @param aJCas the CAS
	...
	/**
	 * simple version where type is <code>GenericAnnotation</code> and threadSafe is false.
	 * 
	 * @param aJCas
	 * @param filterArrays
	 * @return
