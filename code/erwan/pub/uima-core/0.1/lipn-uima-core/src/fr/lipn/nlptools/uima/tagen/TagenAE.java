	...
	public void initialize(UimaContext context) throws ResourceInitializationException {
		...
		if (context.getConfigParameterValue("Language") != null) {
			...
			if (!TAGEN_LANGUAGE_MAP.containsKey(lang)) {
				throw new ResourceInitializationException(LipnExternalProgramGenericAnnotator.LIPN_MESSAGE_DIGEST, "invalid_parameter_list", new Object[]{lang, "Language", TAGEN_LANGUAGE_MAP.keySet().toString()});
			}
		}
	...
	public void process(JCas aJCas)  throws AnalysisEngineProcessException  {
		...
		try {
			...
			if (tagenConfig != null) {
				...
				tagenCommand.add(TAGEN_LANGUAGE_MAP.get(language));
			}
