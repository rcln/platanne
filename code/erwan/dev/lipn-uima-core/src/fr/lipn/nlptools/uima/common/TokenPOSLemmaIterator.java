...
public abstract class TokenPOSLemmaIterator extends GenericTokenIterator<String[]> {
	...
	public TokenPOSLemmaIterator(JCas aJCas, Annotation range, int start, int end, boolean withPOS, boolean withLemma, boolean iterateSentences, String[] regexps, String[] replaceWith, boolean threadSafe, FSMatchConstraint sentenceConstraint, FSMatchConstraint tokenConstraint, FSMatchConstraint posConstraint, FSMatchConstraint lemmaConstraint) {
		this(aJCas, range, start, end, withPOS, withLemma, iterateSentences, DEFAULT_SENTENCE_TYPE, DEFAULT_TOKEN_TYPE, DEFAULT_POS_TYPE, DEFAULT_LEMMA_TYPE, regexps, replaceWith, threadSafe, sentenceConstraint, tokenConstraint, posConstraint, lemmaConstraint);
	}
	...
	public TokenPOSLemmaIterator(JCas aJCas, Annotation range, boolean withPOS, boolean withLemma, boolean iterateSentences, int sentenceType, int tokenType, int posType, int lemmaType, String[] regexps, String[] replaceWith, boolean threadSafe, FSMatchConstraint sentenceConstraint, FSMatchConstraint tokenConstraint, FSMatchConstraint posConstraint, FSMatchConstraint lemmaConstraint) {
		this(aJCas, range, -1, -1, withPOS, withLemma, iterateSentences, sentenceType, tokenType, posType, lemmaType, regexps, replaceWith, threadSafe, sentenceConstraint, tokenConstraint, posConstraint, lemmaConstraint);
	}
