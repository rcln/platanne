...
/**
 * This AE is a wrapper for the LIA program responsible for finding the lemmas (after POS tagging). French and English.
 * Warning: this component seems to output wrong lemmas very frequently.
 * 
 * @author moreau
 *
 */
