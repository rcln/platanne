...
/**
 * This AE is a wrapper for the LIA NE program. It does not use the original LIA NE main script, but instead calls the needed subprograms
 * through a temporary very small script file. This behaviour avoids the problem of converting numbers to letters (see {@link LiaNERawTextAE})
...
public class LiaNETaggedTextAE extends LipnLiaExternalProgramGenericAnnotator {
	...
	public void process(JCas aJCas)  throws AnalysisEngineProcessException  {
		...
		runProgram(aJCas, writerFeeder, new LiaNeAnnotatedReader(aJCas, this, sentenceConstraint, tokenConstraint));
	}
