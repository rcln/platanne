 ...
 *<br/>
 *
 * The {@link #run(WriterFeeder, ReaderConsumer, ReaderConsumer)}
...
public class ExternalProgram {
	...
	/**
	 * By default, after the main process has terminated (without error) the {@link #run(WriterFeeder, ReaderConsumer, ReaderConsumer)} method
